...
import { InputWrapper } from './MentorsMainLeft'

function MentorsMainHeader({ setIsHidden }) {
  const onClickFilterButton = () => {
    setIsHidden(false)
  }

  return (
    <MentorsMainHeaderLayout>
      <MentorsMainHeaderLeft>
        <MentorsMainHeaderFilterButton onClick={() => onClickFilterButton()}>
          <svg
          ...
          >
            <path
              class="sketchy_een"
              d="M29.817,2.858c0.001-0.013,0.008-0.025,0.008-0.038c0-0.418-0.351-0.819-0.78-0.819
	...
	c0.123-0.163,0.245-0.327,0.382-0.478c0.14-0.152,0.337-0.225,0.534-0.225C22.422,7.663,22.629,7.741,22.776,7.888z"
          ...
          필터
        </MentorsMainHeaderFilterButton>
      </MentorsMainHeaderLeft>
      <MentorsMainHeaderRight>
        <MentorsMainHeaderRightInputWrapper>
          <input type="text" />
...
const MentorsMainHeaderLayout = styled.div`
  display: none;
...
const MentorsMainHeaderLeft = styled.div`
  max-width: 50%;
`
...
const MentorsMainHeaderFilterButton = styled.button`
  display: inline-flex;
...
`
export default MentorsMainHeader
