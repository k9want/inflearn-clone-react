    ...
    <footer style={useLoginModal(props.loginModal)}>
      <div className="wrapper">
        <div className="menu-list">
          <div className="menu">
            <div className="menu-dropbox-remote">
              <strong>인프런 </strong>
              <i className="ic-down sm-only"> </i>
            </div>
            <ul className="menu-dropbox">
              <li>
                <a href="/">공지사항</a>
              </li>
              <li>
        ...
        <div className="info">
          <div className="info-left">
            <div className="info-top">
              ...
              <a href="/">
                <span className="info-privacy">개인정보취급방침</span>
              </a>
              <a href="/">
                {' '}
                <span>이용약관</span>
            ...
            <div className="info-bottom">
              <div className="sm-only mobile-footer-info">
                (주)인프랩 사업자 정보
                <button type="button" className="open-button is-active">
                  <i className="ic-down"></i>
                </button>
              </div>
              <div className="footer-dropbox">
                <span className="sm-hidden">(주)인프랩 | </span>
                ...
                <span>
                  이메일:
                  <a href="mailto:info@inflearn.com">info@inflearn.com</a>
                </span>
                <br />
                <span>
            ...
            <div>©INFLAB. ALL RIGHTS RESERVED</div>
          </div>
