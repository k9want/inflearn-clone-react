  ...
  */
  ...
  return (
    <div className="signup-form">
      ...
      <div className="signup-form-info">
        <label className="signup-form-label" htmlFor="passwordConfirm">
          비밀번호 확인
        </label>
        {hiddenPwConfirm ? (
          <div className="signup-form-input input-password">
      ...
      <div className="signup-footer">
        <span className="signup-footer-policy">
          가입 시, 통합 계정으로 인프랩이 제공하는 서비스를 모두 이용하실 수
          있습니다.
          <a
            href="https://www.inflearn.com/policy"
            className="signup-footer-policy-link"
          >
            통합 계정
          </a>
          및 서비스 이용약관 (
          ...
          /
          <a
            href="https://www.rallit.com/terms-of-service"
            className="signup-footer-policy-link"
          >
            랠릿
          </a>
        ...
        <div className="signup-footer-notification">
          <label htmlFor="allow-notification">
