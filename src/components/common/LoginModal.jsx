      ...
      <div class="modal-wrapper">
        ...
        <div class="modal-form">
          <div class="modal-login-info">
            ...
            <div class="modal-form-input input-password">
              ...
              <span class="input-password-toggle-button">
                <svg
                  width="16"
                  height="16"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="social-login">
          <div class="login-line">
            ...
            <span class="social-login-line-text">간편 로그인</span>
          </div>

          <div class="social-login-group">
            <button class="social-button social-login-kakao">
              <svg
                width="18px"
                xmlns="http://www.w3.org/2000/svg"
                height="17"
            ...
            <button class="social-button social-login-google">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
            ...
            <button class="social-button social-login-github">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
            ...
            <button class="social-button social-login-facebook">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="10"
                height="18"
            ...
            <button class="social-button social-login-apple">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="15"
                height="18"
